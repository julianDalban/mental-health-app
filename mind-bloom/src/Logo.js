...
function Logo() {
    return (
        <div className="p-6 max-w-sm mx-auto bg-gradient-to-r from-green-500 from-10% from-emerald-600 rounded-xl shadow-lg flex items-center gap-x-4 hover:from-teal-600 ">
